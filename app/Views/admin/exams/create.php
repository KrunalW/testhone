                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number"
                                       ...
                                       value="<?= old('marks_per_question', 1) ?>"
                                       step="0.25"
                                       min="0.25"
                                       required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select"
                                        ...
                                        required>
                                    <option value="0" <?= old('has_negative_marking', 1) == 0 ? 'selected' : '' ?>>No</option>
                                    <option value="1" <?= old('has_negative_marking', 1) == 1 ? 'selected' : '' ?>>Yes</option>
                                </select>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number"
                                   ...
                                   value="<?= old('max_tab_switches_allowed', 3) ?>"
                                   min="0"
                                   required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select"
                                        ...
                                        required>
                                    <option value="0" <?= old('randomize_questions', 1) == 0 ? 'selected' : '' ?>>No</option>
                                    <option value="1" <?= old('randomize_questions', 1) == 1 ? 'selected' : '' ?>>Yes</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select"
                                        ...
                                        required>
                                    <option value="0" <?= old('randomize_options', 1) == 0 ? 'selected' : '' ?>>No</option>
                                    <option value="1" <?= old('randomize_options', 1) == 1 ? 'selected' : '' ?>>Yes</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
function addSubjectRow() {
    ...
    subjects.forEach(subject => {
        options += `<option value="${subject.id}" data-count="${subject.question_count}">
